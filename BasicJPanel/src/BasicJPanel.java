...
public class BasicJPanel extends JPanel{
    ...
    */
    public void paintComponent(Graphics g){
        g.drawLine(200,10,220,220); // Draw a line from (10,10) to (150,150)
        g.drawOval(200, 200, 225, 225);
        g.drawOval(220, 80, 170, 170);
        g.drawOval(250, 20, 90, 90);
        g.drawOval(265, 25, 10, 10);
        g.drawOval(300, 25, 10, 10);
        g.drawOval(280, 50, 10, 50);
